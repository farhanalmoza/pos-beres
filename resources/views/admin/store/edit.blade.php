        ...
        <div class="card-body">
          <form method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="basic-default-name" value="Toko 1">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label" for="basic-default-message">Alamat Toko</label>
              <div class="col-sm-10">
                <textarea id="basic-default-message" class="form-control">Jl. Rara Santang No. 15 RT.10 RW.05 Kec. Jamblang</textarea>
              </div>
            </div>
