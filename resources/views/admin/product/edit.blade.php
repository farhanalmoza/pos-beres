          ...
          <form method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" value="P01">
              </div>
            </div>
            <div class="mb-3">
              <label class="form-label" for="basic-default-fullname">Nama Barang</label>
              <input type="text" class="form-control" id="basic-default-fullname" value="Lampu Motor LED">
            </div>
            <div class="row mb-3">
              <div class="col-md-8">
                <label class="form-label" for="harga-jual">Harga Jual</label>
                <input type="text" class="form-control" id="harga-jual" value="35.000">
              </div>
              <div class="col-md-4">
                <label class="form-label" for="basic-default-fullname">Stok Minimum</label>
                <input type="number" class="form-control" id="basic-default-fullname" value="50">
              </div>
            </div>
