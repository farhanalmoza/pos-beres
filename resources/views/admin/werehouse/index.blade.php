...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    ...
    <div class="col-12 mb-3">
      <a href="{{ route('admin.werehouse.create') }}" class="btn btn-primary">Buat Akun Gudang</a>
    </div>

    <div class="col-md-12">
      <div class="card">
        <h5 class="card-header">Daftar Akun Gudang</h5>
          ...
          <table class="table">
            ...
            <tbody class="table-border-bottom-0">
              <tr>
                ...
                <td>081234567890</td>
                <td>
                  <a href="{{ route('admin.werehouse.edit', 1) }}" class="btn btn-primary btn-sm">Ubah</a>
