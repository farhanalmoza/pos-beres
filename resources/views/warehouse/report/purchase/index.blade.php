...
@section('title', 'Gudang | Laporan Pembelian Gudang')
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-3">
          ...
          <input class="form-control" type="date" id="start_date" name="start_date" onchange="checkToggleDisabled()">
        </div>
        <div class="col-md-3">
          <label for="end_data">Tanggal Akhir</label>
          <input class="form-control" type="date" id="end_date" name="end_date" onchange="checkToggleDisabled()">
        </div>
...
<script src="{{ asset('js/warehouse/report/purchase.js') }}"></script>
@endsection