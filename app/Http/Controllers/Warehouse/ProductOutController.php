...
class ProductOutController extends Controller
{
    ...
    public function requestList() {
        return view('warehouse.product-out.request');
    }
    ...
    public function getAllRequest() {
        ...
        ->addColumn('actions', function ($item) {
            $btn = '<a href="'.route('warehouse.product-out.detail-request', $item->request_number).'" class="btn btn-success btn-sm">Detail</a>';
            return $btn;
        })
    ...
    public function detailRequest($request_number) {
        ...
        return view('warehouse.product-out.detail-request', compact('productRequest', 'items'));
    }
